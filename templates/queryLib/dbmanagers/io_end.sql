...
drop table io_end purge;

create global temporary table io_end( 
	inst_id number,
	disk varchar2(16),
	name varchar2(60),
	file# number,
...
insert into io_end( inst_id, disk, name, file#, blockreads, blockwrites, writetime, readtime, ratio, io_date, global_name)
SELECT 
